...
class S3ToolsComponent extends Component {
    ...
    public function getS3Object() {
        try {
            ...
            $s3 = S3Client::factory([
                        'credentials' => [
                            'key'    => 'AKIA2YPZSEHCMM6ZS4IU',//$s3Credentials['KEY'],
                            'secret' => '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'//$s3Credentials['SECRET']
                        ],
                        'region'      => 'sa-east-1',//$s3Credentials['REGION'],
