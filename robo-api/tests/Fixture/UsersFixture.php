...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_2' => ['type' => 'foreign', 'columns' => ['users_types_id'], 'references' => ['users_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'users_ibfk_3' => ['type' => 'foreign', 'columns' => ['person_id'], 'references' => ['people', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
