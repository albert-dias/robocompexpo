...
class SubcategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'active' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '1', 'comment' => '', 'precision' => null],
        'margin' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'margin' => 1,
                'created' => '2021-02-02 11:47:05',
                'modified' => '2021-02-02 11:47:05'
            ],
        ];
        parent::init();
    }
