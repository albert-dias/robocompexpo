...
class SubcategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'subcategories_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'subcategories_ibfk_2' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companies', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'created' => '2019-09-20 01:17:18',
                'modified' => '2019-09-20 01:17:18'
            ],
        ];
        parent::init();
    }
