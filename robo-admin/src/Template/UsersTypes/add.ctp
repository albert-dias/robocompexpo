...
$general = [
    ...
    'label_s'     => 'Adicionar',
    'actual'      => 'adcionar tipos de usuários',
    'breadcrumbs' => [
        [
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Cadastrar novo tipo usuário</h4>
                ...
                <div class="row">
                    ...
                    <?= $this->Form->create($usersType, ['type'=> "file"]) ?>
                      
                      <div class="form-group row">
                        <label for="name-text-input" class="col-sm-2 col-form-label">Tipo <span class="required">*</span></label>
                        <div class="col-sm-10">
                          <?= $this->Form->control('type', ['label'=>false,'class'=>"form-control", 'data-validate-length-range'=>"2", 'data-validate-words'=>"1", 'required'=>"required", 'type'=>"text"])?>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label for="name-text-input" class="col-sm-2 col-form-label">Público? <span class="required">*</span></label>
                        <div class="col-sm-10">
                            <?=$this->Form->control('public', ['options' => ['1'=> 'Sim', '0'=>'Não'], 'empty' => 'Selecione', 'label'=> false, 'class'=>'form-control',  'required'=>"required",])?>
                        </div>
                      </div>
                
                      <div class="form-group row">
                        <label for="name-text-input" class="col-sm-2 col-form-label">Módulos <span class="required">*</span></label>
                        <div class="col-sm-10">
