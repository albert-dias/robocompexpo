        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input id="file" type="file" name="file[]" multiple="multiple" accept=".jpg,.png" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?= $this->Form->control('period', ['options' => ['manhã'=>'Manhã','tarde'=>'Tarde','noite'=>'Noite'], 'empty' => 'Selecione', 'label' => false, 'class' => 'form-control', 'required' => "required"]) ?>
                    </div>
                </div>
...
<script src="<?=$this->request->getAttribute('webroot')?>/assets/vendors/kartik-v-bootstrap-fileinput-6e58108/themes/fas/theme.min.js"></script>
<script>

    $(document).ready(function(){
        $("#cep").mask("99999-999");
        $("#quantity-garbage-bags").mask("10.0")
        ...
        <?php 
            ...
            var caminho = "<?= $images->url?>"
            url.push(caminho);
            keys.push({url: "<?=$this->request->getAttribute('base')?>/collection/dellanexo/<?=$images->id?>/<?=$collection->id?>",type:"image"});
        <?php  }  ?>
        ...
        $ ( "#file" ).fileinput({
            ...
            //initialPreview: [ 'https://localhost/flygestor/app/webroot/arquivos/crmmarmore/1_2_337_202010090.png', 'https://localhost/flygestor/app/webroot/arquivos/crmmarmore/1_2_350_202010140.pdf',],
            initialPreview: url,
