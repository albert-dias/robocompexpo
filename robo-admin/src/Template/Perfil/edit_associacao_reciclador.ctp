    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Nome fantansia <span class="required">*</span></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?= $this->Form->control('senha', ['label' => false, 'class' => "form-control", 'data-validate-length-range' => "2", 'data-validate-words' => "1", 'type' => "password","autocomplete"=>"off","autocomplete"=>"new-password"]) ?>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" name="date_of_birth" id="date_of_birth" value="<?=$People->date_of_birth->i18nFormat("yyyy-MM-dd")?>" required="required">
                    </div>
                </div>
