...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Editar Perfil</h4>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="file" id="perfil" class="filepond" name="perfil" accept="image/png, image/jpeg">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Razão Social <span class="required">*</span></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Nome fantasia <span class="required">*</span></label>
                    <div class="col-sm-10">
                        <?= $this->Form->control('nickname', ['value'=>$user->nickname,'label' => false, 'class' => "form-control", 'data-validate-length-range' => "2", 'data-validate-words' => "1", 'required' => "required", 'type' => "text"]) ?>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Data de abertura <span class="required">*</span></label>
                    <div class="col-sm-10">
                        <input type="date" name="date_of_birth" id="date_of_birth" required="required" value="<?=$People->date_of_birth->i18nFormat("yyyy-MM-dd")?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <?= $this->Form->control('password', ['label' => false, 'class' => "form-control", 'data-validate-length-range' => "2", 'data-validate-words' => "1", 'required' => "required", 'type' => "password"]) ?>
                    </div>
                </div>
...
<script>
    ...
    function consultarcpfcnpj(cpfcnpj) {
      ...
      if(cpfcnpj.length == 18){
            ...
            $.ajax({ 
                type: 'POST', 
                url: '<?=$this->request->getAttribute('base')?>/employee/consultacpfcnpjBB/',
