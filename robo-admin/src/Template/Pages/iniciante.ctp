                ...
                <div class="col-xl-12" >
                    <div class="card" style="">
                        ...
                        <?php foreach ($users_categories as $categorie) { ?>
                            <div class="col-md-6 col-sm-4 col-xl-4 " categorie="<?=$categorie->id?>">
                                <div class="form-group d-flex align-items-center">
                                        <div class="col-sm-4">
                                                <img height="47px" width="47px" src="<?=$this->request->getAttribute('webroot')?>webroot/<?=$categorie->url_icon?>" alt="">
                                            <p class="text-break"> 
                                               <?=strlen($categorie->name) > 10 ? substr($categorie->name,0,5)."\n".substr($categorie->name,5):$categorie->name   ?>
                                            </p>
                                        </div>
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="exampleInputEmail1">Estoque/KG</label>
                                            <input type="text" class="form-control stock" value="<?=$categorie->stock != 0 ? $categorie->stock:null ?>">
                                        </div>
                                </div>
                            </div>
                    <?php  }?>
...
async function pricestokeUpdate(){
    ...
    if(pricestoke.length != 0){
       ...
       await Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: "Você precisa preencher tudo!"
                });
    }
}
