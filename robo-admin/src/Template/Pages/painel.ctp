<div class="page-title-box">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            ...
                            <h3 class="mt-4">78.000 kg</h3>
                            <div class="progress mt-4" style="height: 4px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 88%" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="text-muted mt-2 mb-0">Recolhido<span class="float-right">68%</span></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            ...
                            <h3 class="mt-4">999.999,00</h3>
                            <div class="progress mt-4" style="height: 4px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 88%" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="text-muted mt-2 mb-0">Em relação a Meta<span class="float-right">70%</span></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                ...
                <div class="col-sm-6 col-xl-3">
                   <a href="<?=$this->request->getAttribute('base')?>/employee/lists/active" target="_blanck"> 
                    <div class="card">
                            <div class="card-heading p-4">
                                <div class="mini-stat-icon float-right">
    ...
    var f = "DD/MM/Y";
		$('.shawCalRanges').daterangepicker({
			ranges: {
				...
				'Próximo mês': [moment().add(1, 'month').startOf('month').format(f), moment().add(1, 'month').endOf('month').format(f)]
			},
			locale: {
				format: 'DD/MM/YYYY',
				applyLabel: "Ok",
