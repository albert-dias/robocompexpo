<div class="page-title-box">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            ...
                            <p class="text-muted mt-2 mb-0">Previsão período<span class="float-right">75%</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            ...
                            <div>
                                <h5 class="font-16">Total de negócios</h5>
                            </div>
                            <h3 class="mt-4">R$ 73.265,85</h3>
                            <div class="progress mt-4" style="height: 4px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 88%" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="text-muted mt-2 mb-0">Previsão período<span class="float-right">88%</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            ...
                            <h3 class="mt-4">R$ 447,00</h3>
                            <div class="progress mt-4" style="height: 4px;">
                                <div class="progress-bar bg-warning" role="progressbar" style="width: 68%" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="text-muted mt-2 mb-0">Previsão período<span class="float-right">68%</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card">
                        <div class="card-heading p-4">
                            ...
                            <div>
                                <h5 class="font-16">Os em orçamento</h5>
                            </div>
                            <h3 class="mt-4">434</h3>
                            <div class="progress mt-4" style="height: 4px;">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 82%" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p class="text-muted mt-2 mb-0">Previsão período<span class="float-right">82%</span></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Categorias</h4>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Novos prestadores</h4>
                ...
                <div class="col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Cadastro de clientes</h4>
                ...
                <div class="col-xl-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title mb-4">Últimos serviços</h4>
                            <ol class="activity-feed mb-0">
                                <li class="feed-item">
                                    <div class="feed-item-list">
                                        <p class="text-muted mb-1">Now</p>
                                        <p class="font-15 mt-0 mb-0">Troca de lâmpadas: <b class="text-primary">Roberto Gomes</b></p>
                                    </div>
                                </li>
                                <li class="feed-item">
                                    <p class="text-muted mb-1">Yesterday</p>
                                    <p class="font-15 mt-0 mb-0">Limpeza de quintal: <b class="text-primary">Alex Jardineiro</b></p>
                                </li>
                                <li class="feed-item">
                                    <p class="text-muted mb-1">2:30PM</p>
                                    <p class="font-15 mt-0 mb-0">Passeio com cachorro, <b class="text-primary"> Marleno Cuidador Dog</b></p>
                                </li>
                                <li class="feed-item pb-1">
                                    <p class="text-muted mb-1">12:48 PM</p>
                                    <p class="font-15 mt-0 mb-2">Limpeza de ar, <b class="text-primary">Mauricio Refrigeração</b></p>
                                </li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Status das últimas ordens de serviços</h4>
