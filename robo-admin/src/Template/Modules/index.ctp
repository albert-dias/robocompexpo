...
$general = [
    'label'       => 'Módulos',
    'label_s'     => 'Criar novo módulo',
    'actual'      => 'Listar módulos',
    'breadcrumbs' => []
];
...
$sort      = $this->request->params['paging']['Modules']['sort'];
$direction = $this->request->params['paging']['Modules']['direction'];
?>
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Lista de módulos</h4>
                <hr>
                ...
                <div class="row" style="margin-bottom: -25px">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl-3 m-b-30">
                        <?= $this->Form->control('name', ['label'=>false, 'placeholder' =>"Módulo", 'class'=>"form-control", 'type'=>"text"])?>
                      </div>
                    ...
                    <div class="table-responsive b-0" data-pattern="priority-columns">
                       ...
                       <thead>
                        <tr>                            
                            ...
                            <th data-priority="1"><?= $this->Paginator->sort('name', 'Módulo ') ?><i class="<?= 'name' == $sort ? $direction == 'asc' ?  'fas fa-sort-amount-down' : 'fas fa-sort-amount-up':'fa fa-sort'?>"></i></th>
                      ...
                      <tbody>
                          <?php foreach ($modules as $module): ?>
                              <tr>
                                  ...
                                  <td>
                                      <div class="btn-group">
                                          <?= $this->Html->link(__('<i class="fas fa-edit"></i>'), ['action' => 'edit', $module->id], ['escape' => false, 'class'=>"btn btn-primary btn-sm" ]) ?>
                                          <?= $this->Html->link(__('<i class="fas fa-search-plus"></i>'), ['action' => 'view', $module->id], ['escape' => false, 'class'=>"btn btn-info btn-sm" ]) ?>
                                          <?=$this->Html->link('<i class="far fa-trash-alt"></i>',  '#',[ 'data-toggle'=> 'modal', 'data-target' => '#ConfirmDelete', 'data-action'=> Router::url(array('action'=>'delete',$module->id)), 'escape' => false, 'class'=> 'btn btn-danger btn-sm'], false)?>
                                      </div>
                                  </td>
                              </tr>
                          <?php endforeach; ?>
