...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Editar módulo</h4>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?php foreach ($module_plans as $key => $value) {?>
                            <input <?= in_array($value->id,$module_plans_select) ? 'checked': null?> value="<?=$value->id?>" type="checkbox" name="ModulesHasCompany[plans_id][]" id="moduleshascompany-plans-id-<?=$key?>" >
