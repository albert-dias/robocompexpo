...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Cadastrar nova categoria</h4>
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">URl icone <span></span></label>
                    <div class="col-sm-10">
                        <?= $this->Form->control('url_icon', ['label' => false, 'class' => "form-control",  'type' => "text"]) ?>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?= $this->Form->control('description_category', ['label' => false, 'class' => "form-control",'type' => "text"]) ?>
                    </div>
                </div>
