        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="row" style="margin-bottom: -25px">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3 m-b-30">
                        <?= $this->Form->control('email', ['label' => false, 'placeholder' => "E-mail", 'class' => "form-control", 'type' => "text"]) ?>
                    </div>
                    <div class="col-sm-6 col-md-4 col-xl-3 m-b-30">
                        ...
                        <table id="tech-companies-1" class="table  table-striped">
                            <thead>
                                <tr>                            
                                    ...
                                    <th data-priority="2"><?= $this->Paginator->sort('email', 'E-mail') ?><i class="<?= 'email' == $sort ? $direction == 'asc' ? 'fas fa-sort-amount-down' : 'fas fa-sort-amount-up' : 'fa fa-sort' ?>"></i></th>
                                    <th data-priority="2"><?= $this->Paginator->sort('number_contact', 'Contato ') ?><i class="<?= 'number_contact' == $sort ? $direction == 'asc' ? 'fas fa-sort-amount-down' : 'fas fa-sort-amount-up' : 'fa fa-sort' ?>"></i></th>
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        <td><?= $user->id ?></td>
                                        <td><img src="<?= $user->client ?>" width=60 height=40></td>
                                        <td><?= $user->name ?></td>
                                        <td><?= $user->email ?></td>
                                        <td><?= empty($user->person->number_contact) ?  'Sem telefone' : $this->TophoneBR($user->person->number_contact)?> </td>
                                        <td>
                                            <div class="btn-group">
