        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="file" id="perfil" name="perfil" accept="image/png, image/jpeg" required="required">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input max="<?=date('Y-m-d', strtotime('-18 years'))?>" type="date" name="date_of_birth" id="date_of_birth" required="required">
                    </div>
                </div>
        ...
        if (el.value.replace('-', '').length >= 8) {
            ...
            $.getJSON(window.location.protocol + "//api.postmon.com.br/v1/cep/" + el.value.replace('-', ''), function (data) {
                ...
                Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'CEP não encontrado. Informe outro.'
                        });
            });
        }
    }
