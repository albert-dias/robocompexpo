...
$general = [
    ...
    'label_s'     => 'Adicionar',
    'actual'      => 'adcionar ordem de serviço',
    'breadcrumbs' => [
        [
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Cadastrar nova ordem de serviço</h4>
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Prestador</label>
                    <div class="col-sm-10">
                        <?= $this->Form->control('providers_id', ['options' => $providers, 'empty' => 'Selecione', 'label' => false, 'class' => 'form-control',]) ?>
                    </div>
                </div>
