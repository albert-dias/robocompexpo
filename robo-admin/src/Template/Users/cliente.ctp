...
$general = [
    ...
    'actual'      => 'Listar cliente',
    'breadcrumbs' => [[
        'label'=> "Criar novo cliente",
        'link'=> ['action'=>'addcliente']
    ]]
];
                        ...
                        <table id="tech-companies-1" class="table  table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th data-priority="3"><?= $this->Paginator->sort('cpf', 'CPF/CNPJ ') ?><i class="<?= 'type' == $sort ? $direction == 'asc' ? 'fas fa-sort-amount-down' : 'fas fa-sort-amount-up' : 'fa fa-sort' ?>"></i></th>
                                    ...
                                    <th data-priority="3"><?= $this->Paginator->sort('created', 'Cadastro ') ?><i class="<?= 'type' == $sort ? $direction == 'asc' ? 'fas fa-sort-amount-down' : 'fas fa-sort-amount-up' : 'fa fa-sort' ?>"></i></th>
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        <td>
                                            <div class="btn-group">
                                                <?php if($usertype == 1) echo $this->Html->link(__('<i class="fas fa-edit"></i>'), ['action' => 'editcliente', $user->id], ['escape' => false, 'class' => "btn btn-primary btn-sm"]); ?>
