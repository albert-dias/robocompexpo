...
<style>
    ...
    #step-4 .col-xl-12 input[type=checkbox] {
    display:none;
    }
...
<div id="smartwizard">
        <ul class="nav">
            ...
            <div class="tab-content">
                ...
                <h4 class="ml-2 text-center">Quais são os seus dados empresariais?</h4>
                        ...
                        <div class="form-group mb-3 cpf">
                            <label for="name-text-input" class="col-sm-2 col-form-label">CNPJ <span class="required">*</span></label>
                            ...
                            <div class="invalid-feedback" id="cpf-invalid">
                                <span style="font-size: 12px;color: #ff0000;">CNPJ inválido</span>
                            </div>
                ...
                <div id="step-4" class="tab-pane" role="tabpanel">
                    <h4 class="ml-2 text-center">Quais é/são o(os) que você trabalhar?  </h4>
                        <div class="col-sm-12 ">
                            <div class="col-12 mt-3 d-flex justify-content-center ml-sm-4">
                                <div class="d-flex flex-column bd-highlight mb-3">
                                    <div class="col-xl-12 col-sm-4 p-2 flex-fill bd-highlight ml-5">
                                    <ul>
                                        <li><input type="checkbox" id="categorie_id_1" name="categories[]" value="1"/>
                                            <label for="categorie_id_1" style="text-align:center">
                                                <img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/notebook.png" /><br>Assitência <br>Técnica
                                            </label>
                                        </li>
                                        <li><input type="checkbox" id="categorie_id_2" name="categories[]" value="2"/>
                                            <label for="categorie_id_2" style="text-align:center;">
                                                <img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/help-hand.png"/><br><div style="margin-top: 19px;">Suporte</div>
                                            </label>
                                        </li>
                                        <li><input type="checkbox" id="categorie_id_3" name="categories[]" value="3"/>
                                            <label for="categorie_id_3" style="text-align:center">
                                                <img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/network.png" /><br> Infraestrutura e <br>Redes
                                            </label>
                                        </li>
                                        <li><input type="checkbox" id="categorie_id_4" name="categories[]" value="4"/>
                                            <label for="categorie_id_4" style="text-align:center">
                                                <img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/tools.png" /><br> Contrato de <br>Manutenção
                                            </label>
                                        </li>
                                    </ul>
                                        <!-- <input type="checkbox" name="categories[]" id="categorie_id_1" value="1">
                                        <label for="categorie_id_1">Assitência Técnica</label> 
                                        <input class="order-0" type="checkbox" name="categories[]" id="categorie_id_2" value="2">
                                        <label for="categorie_id_2" title="Papel/Papelão">Suporte</label>
                                        <input type="checkbox" name="categories[]" id="categorie_id_3" value="3">
                                        <label for="categorie_id_3">Infraestrutura e </br>Redes</label> 
                                        <input type="checkbox" name="categories[]" id="categorie_id_4" value="4">
                                        <label for="categorie_id_4">Contrato de </br>Manutenção</label>  -->
                                        <!-- <button for="categorie_id_1" class="button border border-white" type="button" 
                                        onclick="$(this).find('input').prop({checked:!this.checked})">
                                            
                                            <figure><img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/notebook.png"></figure>
                                            <label class="text">
                                                <input id="categorie_id_1" type="checkbox" name="categories[]" value="1"> Assitência Técnica
                                            </label>
                                        </button>
                                        <button for="categorie_id_2" class="button border border-white" type="button" style="min-width: 150px;min-height: 170px;"
                                        onclick="$(this).find('input').prop({checked:!checked})">
                                            
                                            <figure><img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/notebook.png"></figure>
                                            <label class="text" style="    margin-bottom: 36px;">
                                                <input id="categorie_id_2" type="checkbox" name="categories[]" value="2"> Suporte
                                            </label>
                                        </button>
                                        <button for="categorie_id_3" class="button border border-white" type="button" 
                                        onclick="$(this).find('input').prop({checked:!checked})">
                                            
                                            <figure><img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/notebook.png"></figure>
                                            <label class="text">
                                                <input id="categorie_id_3" type="checkbox" name="categories[]" value="3"> Infraestrutura e Redes
                                            </label>
                                        </button>
                                        <button for="categorie_id_4" class="button border border-white" type="button" 
                                        onclick="$(this).find('input').prop({checked:!checked})">
                                            
                                            <figure><img src="<?=$this->request->getAttribute("webroot")?>upload/categories/icones/notebook.png"></figure>
                                            <label class="text">
                                                <input id="categorie_id_4" type="checkbox" name="categories[]" value="4"> Contrato de Manutenção
                                            </label>
                                        </button> -->
                                    </div>
                                </div>
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <?php if($is_externo){?>
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">
                    <span>Concordo com o</span>
                    <?= $this->Html->link('Termo de Uso e Política de Privacidade', ['action' => 'termopriv'], ['escape' => false,'target'=>"_black"]) ?>
                    <span class="required">*</span>
                    </label>
                    <div class="col-sm-10">
                        <?= $this->Form->checkbox('termopriv', ['label' => false, 'class' => "form-control", 'required' => "required","style"=>"width:initial !important"]) ?>
                    </div>
                </div>
                <?php } ?>
                <div class="form-group m-b-0">
                    ...
                    <?php if($is_externo){?>
                        <?= $this->Html->link('Cancelar', ['action' => 'login'], ['escape' => false, 'class' => 'btn btn-secondary waves-effect m-l-5']) ?>
                    <?php }else{?>
...
var categorie_id = [];
    $(document).ready(function(){
            ...
            if(currentStepIndex == 0 && stepDirection == "forward"){
                if($("#name").val() != "" && $("#cpf").val() != "" && $("#number-contact").val() != ""){
                    ...
                    await Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: "Você precisa preencher os dados empresariais"
                    });
            ...
            if(currentStepIndex == 2 && stepDirection == "forward"){
                if($("#email").val() != "" && $("#password").val() != ""){
                    ...
                    await Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: "Você precisa preencher os dados de acesso"
                    });
                    $('#smartwizard').smartWizard("prev");
                    return false; 
                }
            ...
            if(currentStepIndex == 3 && stepDirection == "forward"){
                if(categorie_id.length != 0){
                    ...
                    await Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: "Você precisa selecionar pelo menos um tipo de material que você coleta"
                    });
                    $('#smartwizard').smartWizard("prev");
                    return false; 
                }
     ...
     $('#file').filepond('allowMultiple', false);
        ...
        <?php if($is_externo){ ?>
            ...
            //     if($('input[name=pessoa]:checked', '#myForm').val() == "pf"){
            //         check_cpfcnpj = false;
            ...
            //     }
            //     if($('input[name=pessoa]:checked', '#myForm').val() == "pj"){
            //         check_cpfcnpj = true;
            //         $("#cpf").mask("99.999.999/9999-99");
    ...
    function enviar() {
        ...
        if($("#name").val() == "" && $("#cpf").val() == "" && $("#number-contact").val() == ""){
            ...
            $("#step-1 h4").append("(Precisamos saber os seus dados empresariais)");
        ...
        if($("#cep").val() == "" && $("#address").val() == "" && $("#district").val() == "" && $("#city").val() == "" && $("#state").val() == ""){
            ...
            $("#step-2 h4").append("(Precisamos do seu endereço para enviar-lhe coletas)");
        ...
        if($("#email").val() == "" && $("#password").val() == ""){
            ...
            $("#step-3 h4").append("(Esses dados são fundamentais para ter acesso a plataforma)");
            $("#step-3 h4").css("color","red");
            $("#step-3 h4").addClass("animate__animated animate__shakeY")
            return null;
        }
        if(categorie_id.length != 0 || $("#termopriv").prop("checked") != true){
            $('#smartwizard').smartWizard("goToStep", 3);
            $("#step-4 h4").append("(Esses dados são fundamentais para ter acesso a plataforma)");
        ...
        $.ajax({
            url:"<?=$this->request->getAttribute('base')?>/newuser/tecnico"
            ,type:"POST"
