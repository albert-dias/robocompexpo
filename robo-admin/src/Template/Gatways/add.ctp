...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Cadastrar novo gatway de pagamento</h4>
                ...
                <?= $this->Form->create($gatway, ['type' => "file"]) ?>
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">URL <span class="required">*</span></label>
                    <div class="col-sm-10">
                        <?= $this->Form->control('url', ['label' => false, 'class' => "form-control", 'required' => "required", 'type' => "text"]) ?>
                    </div>
                </div>
                
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Login <span class="required">*</span></label>
                    <div class="col-sm-10">
                        <?= $this->Form->control('login', ['label' => false, 'class' => "form-control", 'required' => "required", 'type' => "text"]) ?>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?= $this->Form->control('password', ['label' => false, 'class' => "form-control", 'required' => "required", 'type' => "text"]) ?>
                    </div>
                </div>
                
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">JSON <span class="required">*</span></label>
                    <div class="col-sm-10">
                        <?= $this->Form->control('json', ['label' => false, 'class' => "form-control", 'required' => "required", 'type' => "textarea"]) ?>
                    </div>
                </div>
