...
<div class="row">
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Cadastrar novo cliente</h4>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?= $this->Form->control('number_contact', ['label' => false, 'class' => "form-control", 'data-validate-length-range' => "2", 'data-validate-words' => "1", 'required' => "required", 'type' => "number"]) ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="name-text-input" class="col-sm-2 col-form-label">Cliente ativo? <span class="required">*</span></label>
                    <div class="col-sm-10">
