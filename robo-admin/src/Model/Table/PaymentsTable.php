 ...
 * Payments Model
 *
 * @property &\Cake\ORM\Association\BelongsTo $ServiceOrders
 *
...
class PaymentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->maxLength('transaction_number', 255)
            ->requirePresence('transaction_number', 'create')
            ->notEmptyString('transaction_number');

        $validator
            ->dateTime('date_pay')
            ->requirePresence('date_pay', 'create')
            ->notEmptyDateTime('date_pay');

        $validator
            ->scalar('type_payment')
            ->requirePresence('type_payment', 'create')
            ->notEmptyString('type_payment');

        $validator
            ->numeric('providers_value')
            ->requirePresence('providers_value', 'create')
            ->notEmptyString('providers_value');

        $validator
            ->boolean('providers_transfer')
            ->notEmptyString('providers_transfer');
