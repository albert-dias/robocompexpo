 ...
 * @method \App\Model\Entity\ClientsImage|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ClientsImage saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
