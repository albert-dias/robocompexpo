...
export function FinishedOS() {
    ...
    const [setarID, setSetarID] = useState(null);
            ...
            <View style={{ backgroundColor: theme.colors.gray }}>
                ...
                >
                    <View style={{
                        ...
                        <TouchableOpacity
                            style={{ marginLeft: 10 }}
                            onPress={() => console.log('filterServices()')}>
                            <FontAwesome5
                                name='search'
                    ...
                    <ScrollView style={styles.scrollView}>
                        <View>
                            {/* {(services !== undefined) ? services.map((serv) => ( */}
                            ...
                            <View /* key={serv.id} */ style={styles.anuncioCard}>
                                ...
                                <View style={styles.anuncioInfo}>
                                    <View style={{ flexDirection: 'row' }}>
                                        ...
                                        {/* {(serv.status === 'finalizado' || serv.status === 'avaliado') ? */}
                                        <View style={{
                                            flexDirection: 'row',
                                            marginRight: 10,
                                            marginLeft: 'auto',
                                            ...
                                            <>
                                                ...
                                                <TouchableOpacity
                                                    onPress={() => {
                                                        Alert.alert(
                                                            "AVISO",
                                                            "Gostaria de avaliar o cliente?",
                                                            [{
                                                                text: 'SIM',
                                                                onPress: () => { clientRating(); setSetarID(1) },
                                                                // onPress: () => {console.log('ID: '+serv.id)},
                                                            }, {
                                                                text: 'NÃO',
                                                                onPress: () => { },
                                                            }]
                                            ...
                                            {/* : */}
                                            {/* <>
                                                <Text style={{ maxWidth: '70%', paddingLeft: '6%', marginRight: '-3%' }}>FINALIZADO EM: 12/DEZ/2021</Text>
                                                ...
                                                <Portal>
                                                    ...
                                                    >
                                                        ...
                                                        <TouchableOpacity
                                                            ...
                                                            onPress={() => console.log('avaliation(setarID, star, serv.client_id, serv.company_id, obs)')}
                                                        // onPress={()=>console.log('\nID: '+serv.id,'\nStar: '+star,'\nClient: '+serv.client_id,'\nCompany: '+serv.company_id,'\nOBS: '+obs)}
                                                        >
